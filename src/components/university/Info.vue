<template>
  <div class="user-center">
    <div class="center-header"><h1>用户中心(高校)</h1></div>
    <a-row>
      <a-col :span="24">
        <a-card title="个人信息" class="bdas-card" :headStyle="headStyles">
          <div class="user-card-item">
            <span class="user-card-item-1">学校：</span>
            <span class="user-card-item-2">{{ userInfo.university_name }}</span>
          </div>
          <div class="user-card-item">
          ...
          <div class="user-card-item">
            ...
            <span class="user-card-item-2">高校管理员</span>
          </div>
        </a-card>
      </a-col>
    </a-row>
